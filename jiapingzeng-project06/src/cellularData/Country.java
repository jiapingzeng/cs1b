...
class Country {
    ...
    public Country(Country country) {
        ...
        SubscriptionYear[] oldSubscriptions = country.getSubscriptions();
        subscriptions = new SubscriptionYear[oldSubscriptions.length];
        for (int i = 0; i < subscriptions.length; i++) {
            subscriptions[i] = new SubscriptionYear(oldSubscriptions[i]);
        }
    }
     ...
     */
    SubscriptionYear[] getSubscriptions() {
     ...
     */
    void setSubscriptions(SubscriptionYear[] subscriptions) {
